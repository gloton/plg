...
?>
<link href="<?php print $sitio;?>/css/menu.css" type="text/css" media="screen" rel="stylesheet"  />
    ...
    <div class="contenedor" style="width: 1038px; padding-left: 76px;">
        <div id="redes_sociales">
        	<div class="social-icons">
				<ul>
					<li>
						<a target="_blank" href="http://www.facebook.com/pages/PlataformaGroup/395237797186872" class="facebook">
							<img src="<?php echo $sitio; ?>/images/facebook.png" alt="Logo de facebook" />
						</a>
					</li>
					<li>
						<a target="_blank" href="http://www.linkedin.com/company/1177299" class="linkedin">
							<img src="<?php echo $sitio; ?>/images/linkedin.png" alt="Logo de linkedin" />
						</a>
					</li>
					<li>
						<a target="_blank" href="https://twitter.com/PlataformaGroup" class="twitter">
							<img src="<?php echo $sitio; ?>/images/twitter.png" alt="Logo de twitter" />
						</a>
					</li>
				</ul>
			</div>
        ...
        <div class="acceso">
            ...
            <img src="<?php echo $sitio; ?>/images/white_arrow.png" />
            </div>
        </div>
    </div>
	<div id="header">	
		<div class="contenedor" style="width: 960px;">
			<div id="logo">
			<a href="<?php echo $sitio; ?>/index.php"><img alt="Plataforma Group" title="Plataforma Group" src="<?php echo $sitio; ?>/images/logo.png" /></a>
			</div>
			<div class="logo_iso">
				<img src="<?php echo $sitio; ?>/images/logo-iso-9001.png" alt="Logo iso 9001" alt="Logo iso 9001:2008" />
			</div>
...
<!-- 	<div id="oe_overlay" class="oe_overlay"></div> -->
	<ul id="oe_menu" class="oe_menu">
		...
		<li id="li_nosotros"><a href="javascript:void(0);">NOSOTROS</a>
			<div id="mn_nosotros" style="left:-75px; height: 87px; width: 670px;"><!-- -112px -->
				<ul class="oe_full">
					<li>
						<div id="soluciones_nosotros">
							<div>
								<a href="<?php echo $sitio; ?>/nosotros/empresa.php">
									<div class="box">
										<div class="foto">
											<img src="<?php echo $sitio; ?>/images/menu/logo-relleno-menu.png" alt="imagen de relleno" width="47" height="48" />
										</div>
										<div class="texto">
											<h4>Empresa</h4>
								...
								<a href="<?php echo $sitio; ?>/nosotros/equipo.php">
									<div class="box">
										<div class="foto"><img src="<?php echo $sitio; ?>/images/menu/relleno-equipo.png" alt="imagen de relleno" width="43" height="48" /></div>
										<div class="texto">
											<h4>Equipo</h4>
											<div class="descripcion">
								...
								<a href="<?php echo $sitio; ?>/nosotros/trabaja-con-nosotros.php">
									<div class="box">
										<div class="foto"><img src="<?php echo $sitio; ?>/images/menu/relleno-trabaja-con-nosotros.png" alt="imagen de relleno" width="70" height="48" /></div>
										<div class="texto">
		...
		<li id="li_productos" class="item3_menu"><a href="javascript:void(0);">PRODUCTOS Y SERVICIOS</a>
			<div id="mn_productos" style="left:-112px;padding-right: 8px; padding-bottom: 20px;"><!-- -112px -->
				<ul class="oe_full">
					<li>
						<div id="soluciones_productos" style="width: 668px;">
							<div>
								<a href="<?php echo $sitio; ?>/soluciones/anb.php">
									<div class="box">
										<div class="foto"><img src="<?php echo $sitio; ?>/images/menu/plat_integral_carrusel.jpg" alt="imagen de relleno" width="70" height="48" /></div>
										<div class="texto">
											<h4>ANB</h4>
											<div class="descripcion">
								...
								<a href="<?php echo $sitio; ?>/soluciones/plataforma-cobranza-judicial.php">
									<div class="box">
										<div class="foto"><img src="<?php echo $sitio; ?>/images/menu/plat_cobranza_menu.jpg" alt="imagen de relleno" width="70" height="48" /></div>
										<div class="texto">
											<h4>PCJ</h4>									
											<div class="descripcion">
								...
								<a href="<?php echo $sitio; ?>/soluciones/vitrina-remates.php">									
									<div class="box">
										<div class="foto"><img src="<?php echo $sitio; ?>/images/menu/vitrina_remate_menu.jpg" alt="imagen de relleno" width="70" height="48" /></div>
										<div class="texto">
								...
								<a href="<?php echo $sitio; ?>/soluciones/gestion-examenes-medicos-imad.php">
									<div class="box">
										<div class="foto"><img src="<?php echo $sitio; ?>/images/menu/imad_menu.jpg" alt="imagen de relleno" width="70" height="48" /></div>
										<div class="texto">
											<h4>IMAD</h4>									
											<div class="descripcion">
		...
		<li id="li_clientes"><a href="<?php echo $sitio; ?>/clientes/nuestros-clientes.php">CLIENTES</a></li>
<!-- 				
 ...
 -->		
		...
		<li id="li_noticias"><a href="<?php echo $sitio; ?>/noticias/index.php">NOTICIAS</a>
		</li>
