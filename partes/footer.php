...
<div class="barra-bottom">
	<div id="footer">
		...
		<ul class="listafooter menu_footer_col1">
			<li class="titulista"><a href="javascript:void(0);"
				title="Menu nosotros"><span>Nosotros</span></a></li>
			...
			<li><a href="<?php echo $sitio; ?>/nosotros/trabaja-con-nosotros.php"><span>Trabaja
						con Nosotros</span></a></li>
			<li>&nbsp;</li>
		</ul>
		...
		<ul class="listafooter menu_footer_col3">
			...
			<li><a href="<?php echo $sitio; ?>/clientes/nuestros-clientes.php"
				title="Nuestros Clientes"><span>Clientes</span></a></li>

		</ul>
		<ul class="listafooter menu_footer_col4">
			<li class="titulista"><a href="javascript:void(0);" title="Alianzas"><span>Alianzas</span></a></li>
			<li><a href="<?php echo $sitio; ?>/clientes/nuestros-clientes.php"
		...
		<!-- 
			<ul class="listafooter menu_footer_col6">
	...
	<div class="contenedor">
		<div id="post-footer">Copyright © <?=date('Y');?> PLATAFORMA GROUP.         
            </div>
		<div id="firma-kenya">
