			...
			<div id="wrapperBlog">
				...
				<div id="leftcolumn">
					<div class="post">
						<div class="postSup">
							<div class="introImg">
								<div class="wrapIntroImg"
									style="box-shadow: 0 1px 5px rgba(0, 0, 0, 0.25); padding: 4px; background-color: #FFFFFF; width: 190px; height: 120px;">
									<img class="introThum" src="../images/blog/intro/solmicro.jpg"
										alt="Alianza con solmicro" />
								</div>
							</div>
							<div class="introText">
								<div class="postTitle">
								...
								<div class="postDetail">
									<p>La empresa española SOLMICRO, que cuenta con el software ERP
										más innovador - Solmicro-eXpertis ERP, ha elegido a</p>
								</div>
							</div>
						</div>
						<div class="postInf">
					...
					<div class="post">
						<div class="postSup">
							<div class="introImg">
								<div class="wrapIntroImg"
									style="box-shadow: 0 1px 5px rgba(0, 0, 0, 0.25); padding: 4px; background-color: #FFFFFF; width: 190px; height: 120px;">
									<img class="introThum" src="../images/blog/intro/pb-bci.jpg"
										alt="Caso de exito con BCI" />
								</div>
							</div>
							<div class="introText">
								<div class="postTitle">
								...
								<div class="postDetail">
									<p>La empresa PB Soluciones, ha elegido a PLATAFORMA GROUP como
										proveedor de servicios y a ServiceTonic</p>
								</div>
							</div>
						</div>
						<div class="postInf">
						...
						<div class="postSup">
							<div class="introImg">
								<div class="wrapIntroImg"
									style="box-shadow: 0 1px 5px rgba(0, 0, 0, 0.25); padding: 4px; background-color: #FFFFFF; width: 190px; height: 120px;">
									<img class="introThum"
										src="../images/blog/intro/brp-santander.jpg"
							...
							<div class="introText">
								...
								<div class="postDetail">
									<p>Esta Plataforma diseñada para la Administración de Bienes
										Reposeídos fue construida por PLATAFORMA GROUP el año 2003</p>
								</div>
							</div>
						</div>
						<div class="postInf">
						...
						<div class="postSup">
							<div class="introImg">
								<div class="wrapIntroImg"
									style="box-shadow: 0 1px 5px rgba(0, 0, 0, 0.25); padding: 4px; background-color: #FFFFFF; width: 190px; height: 120px;">
									<img class="introThum"
										src="../images/blog/intro/remates-en-vivo.jpg"
							...
							<div class="introText">
								...
								<div class="postDetail">
									<p>Con gran orgullo ponemos a disposición del mercado nuestro
										moderno servicio de REMATES EN VIVO el cual permite</p>
								</div>
							</div>
						</div>
						<div class="postInf">
						...
						<div class="postSup">
							<div class="introImg">
								<div class="wrapIntroImg"
									style="box-shadow: 0 1px 5px rgba(0, 0, 0, 0.25); padding: 4px; background-color: #FFFFFF; width: 190px; height: 120px;">
									<img class="introThum"
										src="../images/blog/intro/cvc-comaoo.jpg"
							...
							<div class="introText">
								...
								<div class="postDetail">
									<p>Durante el mes de octubre se comenzó la marcha blanca del
										Control de Asistencia desarrollado para</p>
								</div>
							</div>
						</div>
						<div class="postInf">
						...
						<div class="postSup">
							<div class="introImg">
								<div class="wrapIntroImg"
									style="box-shadow: 0 1px 5px rgba(0, 0, 0, 0.25); padding: 4px; background-color: #FFFFFF; width: 190px; height: 120px;">
									<img class="introThum"
										src="../images/blog/intro/certificacion-iso.jpg"
										alt="Certificación ISO9001" />
								</div>
							</div>
							<div class="introText">
								<div class="postTitle">
								...
								<div class="postDetail">
									<p>Durante la tercera semana de Octubre nuestra empresa
										concluyó satisfactoriamente el proceso de</p>
								</div>
							</div>
						</div>
						<div class="postInf">
