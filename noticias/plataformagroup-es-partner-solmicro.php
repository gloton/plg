		...
		<div id="wrapperBlog">
			...
			<div id="leftcolumn">
				...
				<div class="detalle_post">	
					...
					<p><img src="../images/solmicro_186px.jpg" alt="Solmicro" style="float: left; margin: 10px;" />La empresa española SOLMICRO, que cuenta con el software ERP más innovador - 
