...
/*
 * Formulario De Contacto Prop�sito: - Un formulario de contacto con el administrador de la web. Configuraci�n b�sica: - En $email_admin poner el mail del administrador de la web. - Salvar con el nombre deseado con extensi�n .php. - Subir el archivo al servidor. Configuraci�n avanzada: - En //MENSAJES se puede variar todos los mensajes que puedan aparecer, tanto de error como de agradecimiento. - Se puede limitar el tama�o de los campos, tanto el tama�o de la caja como el tama�o m�nimo y m�ximo de los campos. - Si se desea incorporar el formulario a un dise�o ya hecho, al final se tiene que modificar las funciones html y sobre la l�nea 350 esta echo $salida; donde esta todo el c�digo html. Caracter�sticas: - Bastante configurable. - Bastante documentado. - Env�a informaci�n de la IP y hora de envio. - Funciona con register_globals en off. - El xhtml generado es v�lido xhtml 1.1. - El script puede tener cualquier nombre, siempre acabado.php. - Los mails se env�an en formato de texto plano. Requisitos: - Servidor con soporte PHP. Recomendado versi�n 4.3 o superior - Servicio de mail activo. - Ser humano o compatible. Licencia: - Moralmente esta obligado a mantenerme como autor del script y a comunicarme cualquier sugerencia para mejorarlo o fallos que pudiera haber. - Adem�s es GPL (�no?) y opcionalmente "beerware" - Y estar�a bien que me dijeran que les parece y donde lo usa. Control de cambios: + Versi�n 0.3 - opci�n para enviar un acuse de recibo, sugerencia de Kuo Llon. + Versi�n 0.2.1 - bug cuando se env�a mensaje con adjunto, gracias a Silvia + Versi�n 0.2 - control del uso del lenguaje - control del uso de las may�sculas - mas mejoras en la incorporaci�n a otro html + Versi�n 0.1.1 - mejoras en la incorporaci�n a otro html - a�adido copyright final + Versi�n 0.1.0 - a�adido opci�n de env�o de adjuntos. + Versi�n 0.0.7 - peque�os cambios en la documentaci�n. + Versi�n 0.0.6 - m�s mensajes personalizables, en la informaci�n del mail. + Versi�n 0.0.5 - m�s documentaci�n. - cambios en el debug. + Versi�n 0.0.4 - peque�o cambio de empty, de nuevo. - internalizaci�n del c�digo. - mejoras en email_valido, por Aeoris. - me olvide de cerrar el PHP XD. + Versi�n 0.0.3 - arreglada unas comillas en la funci�n de comprobaci�n de mail. - m�s mensajes personalizables. - a�adidos empty en varios sitios, optimizaci�n por OmaR. - mejorado funci�n de mail v�lido, optimizaci�n por OmaR. - a�adido en la hora de env�o la zona horaria. + Versi�n 0.0.2 - m�s documentaci�n. - control total de tama�os m�ximo y m�nimo de los campos. - cambiado REQUEST por POST, para evitar que hagan uso de GET. - arreglado peque�o bug en "if (isset($_POST['form_enviar']))". + Versi�n 0.0.1 - versi�n inicial. Script creado por: www.NoSetup.org <admin@NoSetup.org>
 */
...
/*
 * Integraci�n con otros dise�os. Necesarios conocimientos b�sicos de php y dise�o web El objetivo es poner el script como una p�gina sola, para ello se debe poner FALSE, o bien poner el script dentro de otra p�gina, para ello en la otra p�gina se debera poner TRUE y despu�s incluir el script y llamar a la funci�n. include('contacto.php');			// Incluir el script echo contacto();				// Sacar salida
 */
...

{
...

	{
		...
		/*
		 * Inicio de mensajes de error. Hay que tener en cuenta que no sabemos donde puede fallar y queremos ir acumulando los errores que vayan surgiendo para mostraserlos todos juntos al usuario. Por ello, siempre tendremos que usar el operador "." seguido de "=" para unir los mismos. Si no inicializamos esta variable la primera vez que se usara nos podr�a dar un "notice" indicando el error.
		 */
		...
		if (! email_valido ( $form_email ))
			...
			/*
		 * Tama�os de los campos. C�mo se va a usar un par de veces, se busca acelerar el script y cargar menos el servidor no repitiendo strlen las dos veces.
		 */
		...
		/*
		 * Comprobar tama�os m�nimos. Podr�a pasar que $form_nombre_len fuese 0 pues no estuviese vacio, pero ese error ya lo hemos indicado arriba, por eso a�adimos un && (operador l�gico AND, Y) !empty($form_nombre)
		 */
		...
		if (($form_mensaje_len <= $mensaje_min) && (! empty ( $form_mensaje )))
			...
			/*
		 * Comprar tama�o grande. Pese a que el formulario lo hace lo compruebo pues podr�a haber la posibilidad que se burlase esta seguridad. Adem�s es necesario en el campo mensaje pues en el textarea no se puede especificar el tama�o m�ximo.
		 */
...
/*
 * Funci�n para validar un mail. Devuelve TRUE si el mail tiene el formato correcto. Devuelve FALSE si el mail tiene un formato incorrecto o el dominio no exista.
 */
