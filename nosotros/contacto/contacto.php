...
- Se puede limitar el tamaño de los campos, tanto el tamaño de la caja como el tamaño mínimo y máximo de los campos.
- Si se desea incorporar el formulario a un diseño ya hecho, al final se tiene que modificar las funciones html y sobre la línea 350 esta echo $salida; donde esta todo el código html.

Características:
- Bastante configurable.
- Bastante documentado.
- Envía información de la IP y hora de envio.
- Funciona con register_globals en off.
- El xhtml generado es válido xhtml 1.1.
- El script puede tener cualquier nombre, siempre acabado.php.
- Los mails se envían en formato de texto plano.
...
- Además es GPL (¿no?) y opcionalmente "beerware"
- Y estaría bien que me dijeran que les parece y donde lo usa.

Control de cambios:
+ Versión 0.3
- opción para enviar un acuse de recibo, sugerencia de Kuo Llon.

+ Versión 0.2.1
- bug cuando se envía mensaje con adjunto, gracias a Silvia

+ Versión 0.2
- control del uso del lenguaje
- control del uso de las mayúsculas
- mas mejoras en la incorporación a otro html

+ Versión 0.1.1
- mejoras en la incorporación a otro html
- añadido copyright final

+ Versión 0.1.0
- añadido opción de envío de adjuntos.

+ Versión 0.0.7
 - pequeños cambios en la documentación.

+ Versión 0.0.6
 - más mensajes personalizables, en la información del mail.
...
+ Versión 0.0.4
 - pequeño cambio de empty, de nuevo.
 - internalización del código.
 - mejoras en email_valido, por Aeoris.
 - me olvide de cerrar el PHP XD.

+ Versión 0.0.3
 - arreglada unas comillas en la función de comprobación de mail.
 - más mensajes personalizables.
 - añadidos empty en varios sitios, optimización por OmaR.
 - mejorado función de mail válido, optimización por OmaR.
 - añadido en la hora de envío la zona horaria.

+ Versión 0.0.2
 - más documentación.
 - control total de tamaños máximo y mínimo de los campos.
 - cambiado REQUEST por POST, para evitar que hagan uso de GET.
 - arreglado pequeño bug en "if (isset($_POST['form_enviar']))".
