            ...
            <h1 class="titulos_home">Noticias</h1>
				<div class="accordion">
					...
					<div class="box-accordion" style="display:block;">
						...
						servicio de REMATES EN VIVO el cual permite desde un computador 
						...
						servicios que permite que los participantes web estén escuchando lo que 
						sucede en el Salón de Remates y contagiándose de la adrenalina del mismo, 
						a su vez los participantes del Salón pueden ver en línea las pujas que 
						realizan los participantes de internet.
						</p>
						<p>Esta poderosa herramienta permite la realización en línea de todos los 
						tipos de remates habituales del mercado, incluyendo remates con derecho 
						de selección de cantidad. Para mayor información contáctenos a: 
						<a href="mailto:contacto@platafomagoup.cl">contacto@platafomagoup.cl</a>
						</p>
					</div>
					<h2>Sistema de control de Asistencia CVC-COMAO</h2>
					<div class="box-accordion">
						<p>Durante el mes de octubre se comenzó la marcha blanca del Control 
					...
					<div class="box-accordion">
						<p>Durante la tercera semana de Octubre nuestra empresa concluyó satisfactoriamente 
				...
				<div class="tabs-wrap">
					<dl class="tabs">
						...
						<dd>
							...
							<p><img src="images/solmicro_186px.jpg" alt="Solmicro" style="float:right;" />La empresa española SOLMICRO, que cuenta con el software ERP más innovador - 
						...
						<dd>
							...
							<p><img src="images/blog/intro/pb-bci.jpg" alt="Soluciones - Banco BCI" style="float:right;" />
						...
						<dd>
							...
							<p><img src="images/blog/intro/brp-santander.jpg" alt="BRP para Banco SANTANDER" style="float:right;" />
