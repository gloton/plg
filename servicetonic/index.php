		...
		<div id="content" style="height: 490px;">
				<div id="servicetonic">
					<div id="servicetonic-logo">
						...
						<form name="formularioServicetonic" action="../contacto.php"
							method="post">
							<input name="demo" id="demo" type="hidden" /> <input
								name="desde_servicetonic" id="desde_servicetonic" type="hidden" />
						</form>
					</div>
					<div id="feature_list">
						<ul id="tabs">
							<li><a href="javascript:;"> <img
									src="<?php echo $sitio;?>/images/tabs-vertical-slider/currency_dollar_red-relleno.png" />
									<h3>Beneficios</h3> <span>El mejor Help-Desk, soporte y gestión</span>
							</a></li>
							<li><a href="javascript:;"> <img
									src="<?php echo $sitio;?>/images/tabs-vertical-slider/programming.png" />
									<h3>Areas de aplicación</h3> <span>Cualquier área de su empresa</span>
							</a></li>
							<li><a href="javascript:;"> <img
									src="<?php echo $sitio;?>/images/tabs-vertical-slider/orange-folder-locked-relleno.png" />
									<h3>Gestion de activos</h3> <span>Gran nivel de seguimiento</span>
							</a></li>
							<li><a href="javascript:;"> <img
									src="<?php echo $sitio;?>/images/tabs-vertical-slider/user_manage-relleno.png" />
									<h3>Casos de éxito</h3> <span>Nuestra mejor carta de
										presentación</span>
							</a></li>
						</ul>
						<ul id="output">
				...
				<div id="servicetonic_descargas">
					<ul id="lst_descargas">
						<li id="ver_presentacion"><img class="centered"
							src="../images/servicetonic/plataformagroup_presentacion.png"
							alt="Presentacion ServiceTonic" />
							<p>
								<a href="javascript:void(0);">Presentación Servicetonic</a>
							</p></li>
						<li id="ver_catalogo"><img class="centered"
							src="../images/servicetonic/plataformagroup_catalogo.png"
							alt="Catalogo" />
							<p>
								<a href="javascript:void(0);">Catálogo</a>
							</p></li>
						<li id="ver_volante"><img class="centered"
							src="../images/servicetonic/plataformagroup_volante.png" alt="" />
							<p>
								<a href="javascript:void(0);">Descargar Volante</a>
							</p></li>
						<li id="ver_videos"><img class="centered"
							src="../images/servicetonic/plataformagroup_videos.png" alt="" />
							<p>
								<a href="#">Videos</a>
							</p></li>
					</ul>
